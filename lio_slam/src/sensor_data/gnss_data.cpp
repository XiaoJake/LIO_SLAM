...
//静态成员变量必须在类外初始化
double lio_slam::GNSSData::origin_longitude = 0.0;
double lio_slam::GNSSData::origin_latitude = 0.0;
double lio_slam::GNSSData::origin_altitude = 0.0;
bool lio_slam::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian lio_slam::GNSSData::geo_converter;
